/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     01/11/2012 08:26:06 p.m.                     */
/*==============================================================*/
...
(
   ...
   ESTADO_PERIODO       BOOL,
   UTILIDAD_NETA_PERIODO   DOUBLE(8,2),
   TOTAL_ACTIVO_PERIODO DOUBLE(8,2),
   TOTAL_PASIVO_PERIODO DOUBLE(8,2),
   TOTAL_CAPITAL_PERIODO DOUBLE(8,2),
   TOTAL_COSTO_PERIODO DOUBLE(8,2),
   TOTAL_INGRESOS_PERIODO DOUBLE(8,2),
   TOTAL_CIS_PERIODO    DOUBLE(8,2),
   UTILIDAD_BRUTA_PERIODO    DOUBLE(8,2),
   UTILIDAD_OPERACION_PERIODO    DOUBLE(8,2),
   UTILIDAD_AI_PERIODO    DOUBLE(8,2),
   IMPUESTOS_PERIODO    DOUBLE(8,2),
...
(
   ...
   SALDO_FINAL_SUBCUENTA   FLOAT(8,2),
   PRIMARY KEY (NUMERO_PERIODO, CODIGO_SUBCUENTA)
);
...
ALTER TABLE SALDO ADD CONSTRAINT FK_SALDO2 FOREIGN KEY (CODIGO_SUBCUENTA)
